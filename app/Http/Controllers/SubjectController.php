...
class SubjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $levels  = Level::all();
        return view('Pages.subjects.subject',compact('levels', 'sections','semesters','subjects'));
    }
    ...
    {
      return  $products = DB::table("levels")->where("section_id", $id)->pluck("name", "id");
        return json_encode($products);
    }

    public function getSemesters($id)
    {
        $products = DB::table("semesters")->where("level_id", $id)->pluck("name", "id");
        return json_encode($products);
    }
